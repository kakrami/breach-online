...
export const WEAPON_SPECS = {
  pistol: { name:'PISTOL', short:'PST', mag:12, damage:35, reloadMs:900, cooldownMs:180, bulletSpeed:90, lifetimeMs:3200, adsFov:54, pellets:1, headshotMultiplier:1.50, headshotMinDamage:0, falloffStart:26, falloffEnd:60, minDamageScale:.72, recoilPitch:.0095, recoilYaw:.0030, recoilMaxPitch:.0240, recoilRecovery:15, recoilRecoveryDelayMs:50 },
  assault: { name:'ASSAULT RIFLE', short:'AR', mag:30, damage:28, reloadMs:1450, cooldownMs:100, bulletSpeed:115, lifetimeMs:3000, adsFov:46, pellets:1, headshotMultiplier:1.50, headshotMinDamage:0, falloffStart:42, falloffEnd:92, minDamageScale:.76, recoilPitch:.0058, recoilYaw:.0026, recoilMaxPitch:.0300, recoilRecovery:11.5, recoilRecoveryDelayMs:55, automatic:true },
  ump: { name:'UMP', short:'UMP', mag:30, damage:27, reloadMs:1320, cooldownMs:92, bulletSpeed:105, lifetimeMs:3000, adsFov:49, pellets:1, headshotMultiplier:1.45, headshotMinDamage:0, falloffStart:25, falloffEnd:62, minDamageScale:.68, recoilPitch:.0049, recoilYaw:.0034, recoilMaxPitch:.0280, recoilRecovery:13, recoilRecoveryDelayMs:45, automatic:true },
  shotgun: { name:'PUMP SHOTGUN', short:'SG', mag:6, damage:16, reloadMs:620, cooldownMs:800, bulletSpeed:100, lifetimeMs:1700, adsFov:52, pellets:8, headshotMultiplier:1.10, headshotMinDamage:0, falloffStart:10, falloffEnd:26, minDamageScale:.38, recoilPitch:.0175, recoilYaw:.0042, recoilMaxPitch:.0260, recoilRecovery:9.5, recoilRecoveryDelayMs:80, shellReload:true },
  ...
  sniper: { name:'SNIPER', short:'SNP', mag:5, damage:110, reloadMs:1650, cooldownMs:1050, bulletSpeed:240, lifetimeMs:2400, adsFov:18, pellets:1, headshotMultiplier:1.50, headshotMinDamage:0, falloffStart:115, falloffEnd:190, minDamageScale:.92, recoilPitch:.0290, recoilYaw:.0048, recoilMaxPitch:.0380, recoilRecovery:8.2, recoilRecoveryDelayMs:90 },

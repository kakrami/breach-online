export const APP_VERSION = '1.44.17';
...
export const ATTACHMENTS = Object.freeze({
  ...
  shortBarrel:Object.freeze({id:'shortBarrel',slot:'barrel',name:'SHORT BARREL',short:'SHORT',description:'-10% velocity · -14% range · faster ADS / sprint-out · more horizontal recoil.',compatible:Object.freeze(['assault','ump']),mods:Object.freeze({bulletSpeed:.90,falloffStart:.86,falloffEnd:.86,adsInMs:.90,sprintOutMs:.86,recoilYaw:1.08,recoilMaxYaw:1.06}),adsMoveAdd:.05}),
  ...
  angledGrip:Object.freeze({id:'angledGrip',slot:'underbarrel',name:'ANGLED GRIP',short:'ANG',description:'-12% ADS time · -8% sprint-out · +8% recoil.',compatible:Object.freeze(['assault','ump','machineGun']),mods:Object.freeze({adsInMs:.88,sprintOutMs:.92,recoilPitch:1.08,recoilYaw:1.08,recoilMaxPitch:1.04,recoilMaxYaw:1.06})}),

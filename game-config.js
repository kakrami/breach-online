export const APP_VERSION = '1.44.53';
...
export const ATTACHMENTS = Object.freeze({
  ...
  bipod:Object.freeze({id:'bipod',slot:'underbarrel',name:'BIPOD',short:'BIPOD',compatible:Object.freeze(['machineGun']),mods:Object.freeze({}),conditionalRecoilScale:.62}),
  laser:Object.freeze({id:'laser',slot:'underbarrel',name:'LASER',short:'LASER',compatible:Object.freeze(['pistol','akimbo1887','assault','ump','machineGun','shotgun','semiShotgun','sniper','rpg']),mods:Object.freeze({}),accuracyMods:Object.freeze({hipDeg:.90,adsDeg:.90,moveDeg:.90,airborneDeg:.90,slideDeg:.90,fireDeg:.90,fireMaxDeg:.90})}),
...
export const WEAPON_SPECS = {
  ...
  sniper: { name:'SNIPER', short:'SNP', mag:5, damage:115, playerPenetrationRetention:.92, lowerBodyDamageScale:.76, armDamageScale:.72, reloadMs:1950, cooldownMs:1150, bulletSpeed:700, lifetimeMs:2000, adsFov:18, adsInMs:250, adsOutMs:175, adsMoveSpeedScale:.72, sprintOutMs:300, sprintAdsMs:190, pellets:1, headshotMultiplier:1.50, headshotMinDamage:0, falloffStart:130, falloffEnd:200, minDamageScale:.88, recoilPitch:.066, recoilYaw:.0112, firstShotRecoilScale:.84, recoilMaxPitch:.087, recoilRecovery:7.8, recoilRecoveryDelayMs:100 },

...
export const WEAPON_SPECS = {
  pistol: { name:'PISTOL', short:'PST', mag:12, damage:35, reloadMs:900, cooldownMs:180, bulletSpeed:180, lifetimeMs:3200, adsFov:54, pellets:1, headshotMultiplier:1.50, headshotMinDamage:0, falloffStart:26, falloffEnd:60, minDamageScale:.72, recoilPitch:.0095, recoilYaw:.0030, recoilMaxPitch:.0240, recoilRecovery:15, recoilRecoveryDelayMs:50 },
  assault: { name:'ASSAULT RIFLE', short:'AR', mag:30, damage:28, reloadMs:1450, cooldownMs:100, bulletSpeed:230, lifetimeMs:3000, adsFov:46, pellets:1, headshotMultiplier:1.50, headshotMinDamage:0, falloffStart:42, falloffEnd:92, minDamageScale:.76, recoilPitch:.0058, recoilYaw:.0026, recoilMaxPitch:.0300, recoilRecovery:11.5, recoilRecoveryDelayMs:55, automatic:true },
  ump: { name:'UMP', short:'UMP', mag:30, damage:27, reloadMs:1320, cooldownMs:92, bulletSpeed:210, lifetimeMs:3000, adsFov:49, pellets:1, headshotMultiplier:1.45, headshotMinDamage:0, falloffStart:25, falloffEnd:62, minDamageScale:.68, recoilPitch:.0049, recoilYaw:.0034, recoilMaxPitch:.0280, recoilRecovery:13, recoilRecoveryDelayMs:45, automatic:true },
  ...
  semiShotgun: { name:'SEMI-AUTO SHOTGUN', short:'SAS', mag:8, damage:12, reloadMs:1550, cooldownMs:330, bulletSpeed:200, lifetimeMs:1750, adsFov:51, pellets:8, headshotMultiplier:1.10, headshotMinDamage:0, falloffStart:9, falloffEnd:24, minDamageScale:.36, recoilPitch:.0135, recoilYaw:.0052, recoilMaxPitch:.0320, recoilRecovery:9, recoilRecoveryDelayMs:70 },

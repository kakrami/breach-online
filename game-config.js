...
export const WEAPON_ORDER = ['pistol','akimbo1911','assault','ump','shotgun','semiShotgun','sniper','grenadeLauncher','rpg'];
export const PRIMARY_WEAPONS = ['assault','ump','shotgun','semiShotgun','sniper','grenadeLauncher','rpg'];
export const SECONDARY_WEAPONS = ['pistol','akimbo1911'];
export const WEAPON_SPECS = {
  ...
  akimbo1911: { name:'1911 AKIMBO', short:'1911×2', mag:16, damage:31, playerPenetrationRetention:.38, reloadMs:1350, cooldownMs:85, bulletSpeed:178, lifetimeMs:3000, adsFov:70, sprintOutMs:125, sprintAdsMs:0, pellets:1, headshotMultiplier:1.42, headshotMinDamage:0, falloffStart:15, falloffEnd:42, minDamageScale:.56, recoilPitch:.024, recoilYaw:.008, firstShotRecoilScale:.72, recoilMaxPitch:.060, recoilRecovery:14, recoilRecoveryDelayMs:55, akimbo:true },
...
export const WEAPON_ACCURACY = {
  ...
  akimbo1911: { hipDeg:2.15, adsDeg:2.15, moveDeg:0.82, adsMoveScale:1, airborneDeg:1.85, crouchScale:0.88, slideDeg:1.05, fireDeg:0.34, fireMaxDeg:1.45, heatRecoveryMs:180 },

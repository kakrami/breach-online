...
export function createAuthoredServerCollision(world){
  ...
  function segmentFirstObstacleT(x1, y1, z1, x2, y2, z2, radius = 0) {
  ...
  function segmentFirstWorldHitT(x1, y1, z1, x2, y2, z2, radius = 0) {
  ...
  function blastHasLineOfSight(x1, y1, z1, x2, y2, z2, clearance = 0.22) {
  ...
  function segmentHitsObstacle(x1, y1, z1, x2, y2, z2, radius = 0) {
  ...
  return {projectileSegmentHitZone,segmentFirstObstacleT,segmentFirstWorldHitT,segmentFirstWorldOcclusionT,blastHasLineOfSight,segmentHitsObstacle,actorHasLineOfSight};
}

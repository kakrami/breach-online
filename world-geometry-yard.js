...
// Keep the shared network arena envelope at 120m; this map's physical yard is
// intentionally enclosed to a compact ~68m square by its perimeter structures.
export const ARENA_LIMIT = 120;
export const MINIMAP_LIMIT = 40;
export const MAX_STEP_HEIGHT = 0.62;
export const CROUCH_WINDOW_STEP_HEIGHT = 0.86;

export const STATIC_BOXES = [
  // Perimeter structures create the compact close-quarters play space.
  {x:-37,z:0,w:6,d:80,h:4.8,kind:'boundary'}, {x:37,z:0,w:6,d:80,h:4.8,kind:'boundary'},
  {x:0,z:-37,w:80,d:6,h:4.8,kind:'boundary'}, {x:0,z:37,w:80,d:6,h:4.8,kind:'boundary'},

  // Full-height freight containers. The arrangement deliberately leaves four
  // crossing lanes plus short flank pockets rather than copying another map.
  {x:-22,z:-20,w:14,d:3.2,h:2.85,kind:'containerBlue'},
  {x:22,z:20,w:14,d:3.2,h:2.85,kind:'containerRed'},
  {x:20,z:-20,w:3.2,d:14,h:2.85,kind:'containerTan'},
  {x:-20,z:20,w:3.2,d:14,h:2.85,kind:'containerGreen'},
  {x:-25,z:2,w:6,d:14,h:5.70,kind:'containerRed'},
  {x:25,z:-2,w:6,d:14,h:5.70,kind:'containerBlue'},
  {x:0,z:-24,w:14,d:3.2,h:2.85,kind:'containerGreen'},
  {x:0,z:24,w:14,d:3.2,h:2.85,kind:'containerTan'},
  {x:-9,z:-7,w:3.2,d:12,h:2.85,kind:'containerTan'},
  {x:9,z:7,w:3.2,d:12,h:2.85,kind:'containerBlue'},

  // Mantle-height crate islands break long sightlines without sealing lanes.
  {x:0,z:0,w:6,d:6,h:1.45,kind:'crate'},
  {x:-12,z:7,w:5,d:3,h:1.35,kind:'crate'},
  {x:12,z:-7,w:5,d:3,h:1.35,kind:'crate'},
...
export const COMBAT_FLOW_NODES = Object.freeze([
  Object.freeze({x:-29,z:-28}),Object.freeze({x:-29,z:-14}),Object.freeze({x:-29,z:14}),Object.freeze({x:-28,z:28}),
  Object.freeze({x:-17,z:-29}),Object.freeze({x:-17,z:-11}),Object.freeze({x:-17,z:5}),Object.freeze({x:-17,z:29}),
  Object.freeze({x:-5,z:-30}),Object.freeze({x:-5,z:-17}),Object.freeze({x:-5,z:-6}),Object.freeze({x:-5,z:7}),Object.freeze({x:-5,z:28}),
  Object.freeze({x:5,z:-28}),Object.freeze({x:5,z:-7}),Object.freeze({x:5,z:6}),Object.freeze({x:5,z:17}),Object.freeze({x:5,z:30}),
  Object.freeze({x:17,z:-29}),Object.freeze({x:17,z:-5}),Object.freeze({x:17,z:11}),Object.freeze({x:17,z:29}),
  Object.freeze({x:29,z:-28}),Object.freeze({x:29,z:-14}),Object.freeze({x:29,z:14}),Object.freeze({x:29,z:28}),
  Object.freeze({x:0,z:-12}),Object.freeze({x:0,z:12}),Object.freeze({x:-13,z:0}),Object.freeze({x:13,z:0})
]);
...
export function rawTerrainHeight(x,z){
  // A nearly level concrete yard with just enough drainage variation to avoid a
  // mathematically flat-looking surface while remaining fair for close combat.
  const slab=0.18+0.035*Math.sin(x*0.11)+0.028*Math.cos(z*0.09)+0.018*Math.sin((x+z)*0.07);
  return clamp(slab,0.08,0.30);
}
...
export const STATIC_PLAYER_COLLIDERS = STATIC_BOXES.map(o=>{
  ...
  return {type:'box',x:o.x,z:o.z,w:o.w,d:o.d,minX:o.x-o.w/2,maxX:o.x+o.w/2,minZ:o.z-o.d/2,maxZ:o.z+o.d/2,minY,maxY:minY+o.h,role:'static',supportTop:true};
});

export const NATURAL_PLAYER_COLLIDERS = NATURAL_OBSTACLES.map(o=>{
  const minY=naturalGroundBase(o.type,o.x,o.z,o.r);
  if(o.type==='tree')return {type:'round',x:o.x,z:o.z,r:o.r*.72,minY,maxY:minY+o.h*.64,role:'tree',supportTop:false};
  if(o.type==='bush'){
...
export const BUILDING_PLAYER_COLLIDERS = [
  ...BUILDING_PARTS.filter(p=>p.playerSolid).map(p=>({type:'box',x:p.x,z:p.z,w:p.w,d:p.d,minX:p.x-p.w/2,maxX:p.x+p.w/2,minZ:p.z-p.d/2,maxZ:p.z+p.d/2,minY:p.bottomY,maxY:p.topY,role:p.role,crouchStep:!!p.crouchStep,supportTop:!!p.supportTop})),
